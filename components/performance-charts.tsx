          ...
          {(['24h', '7d', '30d'] as TimePeriod[]).map((period) => (
            <button
              ...
              className={`px-3 py-1.5 text-sm rounded-md transition-colors ${
                timePeriod === period
                  ? 'bg-[#EC9117] text-[#0A0E1A] font-medium'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="border-border/40 bg-card/50">
          <CardHeader>
            ...
            <CardDescription>Fees generated by the vault over the selected period</CardDescription>
            {currentFees !== null && (
              <div className="mt-2">
                <span className="text-[#EC9117] font-mono text-lg">
                  {timePeriod} Fees: ${formatNumber(currentFees, 1)}k
                </span>
              </div>
            )}
          </CardHeader>
        ...
        <Card className="border-border/40 bg-card/50">
          <CardHeader>
            ...
            <CardDescription>Vault's token composition changed over time.</CardDescription>
            {currentInventory && (
              <div className="mt-2">
                <span className="text-[#EC9117] font-mono text-lg">
                  Current: {currentInventory.token0}/{currentInventory.token1}%
                </span>
              </div>
            )}
          </CardHeader>
